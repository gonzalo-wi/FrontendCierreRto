...
export const getStatusClass = (estado) => {
  ...
  if (typeof estado === 'string') {
    switch (estado) {
      case 'PENDIENTE':
        return 'bg-gradient-to-r from-red-100 to-red-100 text-red-800 border-red-200' // Rojo
      case 'LISTO':
        return 'bg-gradient-to-r from-yellow-100 to-yellow-100 text-yellow-800 border-yellow-200' // Amarillo
      case 'ENVIADO':
        return 'bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 border-green-200' // Verde
      case 'EXACTO':
...
export const getRowClass = (estado) => {
  ...
  if (typeof estado === 'string') {
    switch (estado) {
      case 'PENDIENTE':
        return 'bg-red-50 hover:bg-red-100 border-l-4 border-red-400' // Rojo
      case 'LISTO':
      case 'EXACTO':
        return 'bg-yellow-50 hover:bg-yellow-100 border-l-4 border-yellow-400' // Amarillo
      case 'ENVIADO':
        return 'bg-green-50 hover:bg-green-100 border-l-4 border-green-400' // Verde
      case 'SOBRANTE':
